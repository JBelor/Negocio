...
<div class="container text-center my-3">
    <h1 class="font-weight-light">Computo</h1>
                ...
                <div class="carousel-item active">
                    <div class="col-md-4 p-2">
						...
						<div class="card-block">
							...
							<p>
								<a class="btn btn-primary" href="#">Ver</a> <a class="btn btn-warning" href="#">Agregar al carrito</a>
							</p>
						</div>
                        </div>
                    </div>
...
<!-- Segundo carrusel -->
<div class="container text-center my-3">
    <h1 class="font-weight-light">Audio</h1>
    <div class="row mx-auto my-auto">
                ...
                <div class="carousel-item active">
                    <div class="col-md-4 p-2">
						...
						<div class="card-block">
							...
							<p>
								<a class="btn btn-primary" href="#">Action</a> <a class="btn btn-warning" href="#">Agregar al carrito</a>
							</p>
						</div>
                        </div>
                    </div>
				...
				<div class="carousel-item ">
                    <div class="col-md-4 p-2">
						...
						<div class="card-block">
							...
							<p>
								<a class="btn btn-primary" href="#">Action</a> <a class="btn btn-warning" href="#">Action</a>
							</p>
						</div>
                        </div>
                    </div>
